...
export const observedPropertyNavigationLink = observedProperty + navigationLink
...
export const excludedFields = {
  Datastreams: commonExcludedFields.concat([
    thing,
    thingId,
    sensor,
    sensorId,
  ...
  Observations: commonExcludedFields.concat([
    featureOfInterest,
    featureOfInterestId,
    datastream,
    datastreamId,
