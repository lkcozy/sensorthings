...
db().then(models => {
  ...
  const DatastreamWithLocationEntity = Object.assign(
    {},
    CONST.DatastreamsEntity,
    {
  ...
  describe('CreateObservations tests', () => {
    ...
    it('Create observations specifying FeatureOfInterest', done => {
      ...
      models[CONST.datastreams]
        .create(CONST.DatastreamsEntity)
        .then(relation => {
          const datastreamId = relation.id
          body[0].Datastream[CONST.iotId] = datastreamId
          models[CONST.featuresOfInterest]
            .create(CONST.FeaturesOfInterestEntity)
            .then(foiRelation => {
              const featureOfInterestIndex = body[0].components.indexOf(
                featureOfInterestId
              )
    ...
    it('Create observations without specifying FeatureOfInterest', done => {
      ...
      server
        ...
        .send(DatastreamWithLocationEntity)
    ...
    it('Missing result component', done => {
      postError(
        ...
        CreateObservationsRequestMissingResult,
        400,
    ...
    it('Unknown component', done => {
      postError(
        ...
        400,
        'Invalid component: ' + unknownComponent
      )
    })
    ...
    it('iot.count, dataArray length mismatch', done => {
      postError(
        ...
        CreateObservationsRequestIotCountDataArrayLengthMismatch,
        400,
      ...
      models[CONST.datastreams]
        ...
        .then(relation => {
          ...
          models[CONST.featuresOfInterest]
            ...
            .then(foiRelation => {
              body.forEach(obj => {
                const featureOfInterestIndex = obj.components.indexOf(
                  featureOfInterestId
                )
