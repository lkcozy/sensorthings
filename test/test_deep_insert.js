  ...
  describe('Deep insert', () => {
    describe('Deep insert /Things', () => {
      ...
      after(done => {
        ...
        server
          .delete(prepath + things + '(' + thingId + ')')
          .expect(200)
          .end(err => {
            should.not.exist(err)
            fetch(prepath + things)
              .then(res => {
    ...
    describe('Deep insert /Observations', () => {
      ...
      after(done => {
        server
          .delete(prepath + observations + '(' + observationId + ')')
          .expect(200)
          .end(err => {
            should.not.exist(err)
      ...
      it('should create Observation entity and all its associations', done => {
        ...
        fetch(prepath + observations)
          .then(res => {
            ...
            featureOfInterestLink = featureOfInterestLink.replace(serverUrl, '')
