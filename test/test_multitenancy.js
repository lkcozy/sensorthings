...
Object.keys(entities).forEach(endpoint => {
  app.use(
    route.generate(API_VERSION, endpoint),
  ...
  return db()
    ...
    .then(() => {
      ...
      for (let i = 0; i < clientIds.length; i++) {
        ...
        promises.push(
          models[entity].create(instance).then(result => {
  ...
  Object.keys(entities).forEach(entity => {
      ...
      it('GET /' + entity + ' should get all entities', done => {
        ...
        server
          ...
          .end((err, res) => {
            ...
            res.body.value.should.be.instanceof(Array).and.have.lengthOf(4)
            done()
          })
      })
      ;[
    ...
    describe('POST /' + entity, () => {
      ...
      ;[
        ...
        it(`${testName} should store a entity owned by a specific tenant`, done => {
          ...
          server
            ...
            .end((err, res) => {
              ...
              server
                .get(getPath + '?clientId=3&userId=3')
                .expect(404)
                .end(_err => {
    ...
    describe('DELETE /' + entity, () => {
      ...
      it(
        'DELETE /' +
          entity +
          ' should respond 404 if request contains ' +
          'wrong clientId',
        done => {
          let path = prepath + entity
