...
const mandatory = ['phenomenonTime', 'result']
...
commonTests(observations, 8885, mandatory, optional).then(tester => {
  describe('Observations specific tests', () => {
    ...
    describe('POST to association URL', () => {
      it(
        'should return 201 when creating a Observation, pointing to an ' +
          'association URL',
        done => {
          db().then(models => {
    ...
    describe('POST without FeatureOfInterest', () => {
      ...
      it(
        'should return 400 when assigning an existing Datastream without ' +
          'location',
        done => {
          db().then(models => {
            models[datastreams].create(DatastreamsEntity).then(relation => {
      ...
      describe('More than one Observation without FeatureOfInterest', () => {
        ...
        it(
          'should create only 1 FeatureOfInterest for a Datastream with ' +
            'Observations and a linked FeatureOfInterest',
          done => {
      ...
      it(
        'should return 201 when linking a Datastream entity with a linked ' +
          'Thing',
        done => {
          db().then(models => {
      ...
      it(
        'should return 201 when linking a Datastream entity with a linked ' +
          'Thing entity, and a Location id',
        done => {
          db().then(models => {
