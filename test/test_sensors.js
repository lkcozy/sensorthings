...
import { BAD_REQUEST, ERRNO_VALIDATION_ERROR } from '../src/errors'
  ...
  describe('Sensors API - specific', () => {
    describe('Check invalid ecodingTypes', () => {
      [
        ...
        CONST.encodingTypes.LOCATION_TYPE,
      ].forEach(type => {
    ...
    describe('Get FeaturesOfInterest from Locations', () => {
      ...
      it(
        'should respond 201 when inserting a Sensor with a Observation ' +
